...
if     (VERSION_OF_MDBOOK_FOOTNOTE STREQUAL "[none]")
    set(CRATE_OF_MDBOOK_FOOTNOTE "")
elseif (VERSION_OF_MDBOOK_FOOTNOTE STREQUAL "")
    set(CRATE_OF_MDBOOK_FOOTNOTE "mdbook-footnote")
else()
    set(CRATE_OF_MDBOOK_FOOTNOTE "mdbook-footnote@${VERSION_OF_MDBOOK_FOOTNOTE}")
endif()
remove_cmake_message_indent()
message("")
...
message("VERSION_OF_MDBOOK_FOOTNOTE     = ${VERSION_OF_MDBOOK_FOOTNOTE}")
...
message("CRATE_OF_MDBOOK_FOOTNOTE       = ${CRATE_OF_MDBOOK_FOOTNOTE}")
message("")
execute_process(
...
message(STATUS "Running 'cargo build' command to compile the 'mdbook-prql' crate...")
if (CMAKE_HOST_LINUX)
    set(ENV_PATH                "${PROJ_CONDA_DIR}/bin:$ENV{PATH}")
    set(ENV_LD_LIBRARY_PATH     "${PROJ_CONDA_DIR}/lib:$ENV{LD_LIBRARY_PATH}")
    set(ENV_CARGO_INSTALL_ROOT  "${PROJ_CONDA_DIR}")
