...
foreach(_LANGUAGE ${LANGUAGE_LIST})
    ...
    message(STATUS "Running 'mdbook build' command with '${MDBOOK_RENDERER}' renderer to build documentation for '${_LANGUAGE}' language...")
    if (CMAKE_HOST_LINUX)
...
set(UPSTREAM_DOCS   "https://prql-lang.org/book")
set(UPSTREAM_REPO   "https://github.com/PRQL/prql")
